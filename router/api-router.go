...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.GET("/subscription", controller.GetSubscriptionSummary)
			selfRoute.GET("/subscription/orders", controller.GetSubscriptionOrders)
			selfRoute.POST("/subscription/amount", controller.GetSubscriptionAmount)
			selfRoute.POST("/subscription/balance", middleware.CriticalRateLimit(), controller.PurchaseSubscriptionWithBalance)
			selfRoute.POST("/subscription/pay", middleware.CriticalRateLimit(), controller.RequestSubscriptionEpay)
			selfRoute.POST("/subscription/stripe/pay", middleware.CriticalRateLimit(), controller.RequestSubscriptionStripePay)
			selfRoute.POST("/subscription/redeem", middleware.CriticalRateLimit(), controller.RedeemSubscription)
		...
		{
			subscriptionPlanRoute.GET("/", controller.GetSubscriptionPlans)
			subscriptionPlanRoute.POST("/", controller.CreateSubscriptionPlan)
			subscriptionPlanRoute.PUT("/", controller.UpdateSubscriptionPlan)
		}

		subscriptionRedemptionRoute := apiRouter.Group("/subscription_redemption")
		subscriptionRedemptionRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionRedemptionRoute.DELETE("/invalid", controller.DeleteInvalidSubscriptionRedemptions)
		...
		dataRoute.GET("/region_stats", middleware.AdminAuth(), controller.GetAllRegionStats)
