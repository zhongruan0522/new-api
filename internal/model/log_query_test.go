...
func setupLogQueryTestDB(t *testing.T) {
	...
	if err := db.AutoMigrate(&User{}, &Log{}, &Channel{}); err != nil {
...
func TestLogQueryOrderByCreatedAtDesc(t *testing.T) {
	...
	rows := []*Log{
		{UserId: 1, CreatedAt: base + 30, Type: LogTypeConsume, ModelName: "m", ChannelId: 1, Group: "default", Quota: 11},
		{UserId: 1, CreatedAt: base + 10, Type: LogTypeConsume, ModelName: "m", ChannelId: 1, Group: "default", Quota: 12},
		{UserId: 1, CreatedAt: base + 50, Type: LogTypeConsume, ModelName: "m", ChannelId: 1, Group: "default", Quota: 31},
		{UserId: 1, CreatedAt: base + 50, Type: LogTypeConsume, ModelName: "m", ChannelId: 1, Group: "default", Quota: 32},
		{UserId: 1, CreatedAt: base + 20, Type: LogTypeConsume, ModelName: "m", ChannelId: 1, Group: "default", Quota: 13},
	}
	...
	t.Run("GetUserLogs returns newest first with stable tiebreaker", func(t *testing.T) {
		...
		logs, total, err := GetUserLogs(1, LogTypeUnknown, 0, 0, "", "", 0, 100, "", "", "", "", "", "", "")
		if err != nil {
	...
	t.Run("GetUserLogs respects created_at range filter", func(t *testing.T) {
		...
		logs, total, err := GetUserLogs(1, LogTypeUnknown, base+15, base+45, "", "", 0, 100, "", "", "", "", "", "", "")
		if err != nil {
			t.Fatalf("GetUserLogs error = %v", err)
		}
		if total != 2 {
	...
	t.Run("GetUserLogs pagination preserves order", func(t *testing.T) {
		...
		page1, _, err := GetUserLogs(1, LogTypeUnknown, 0, 0, "", "", 0, 2, "", "", "", "", "", "", "")
		if err != nil {
		...
		page2, _, err := GetUserLogs(1, LogTypeUnknown, 0, 0, "", "", 2, 2, "", "", "", "", "", "", "")
		if err != nil {
...
func assertOrder(t *testing.T, logs []*Log, wantCreatedAt []int64, wantQuota []int) {
	t.Helper()
...
func collectCreatedAt(logs []*Log) []int64 {
...
func collectQuota(logs []*Log) []int {
