...
func createClaudeFileSource(data string) *FileSource {
...
func (c *ClaudeRequest) GetTokenCountMeta() *TokenCountMeta {
...
func (c *ClaudeResponse) GetClaudeError() *ClaudeError {
	if c.Error == nil {
		return nil
	}
