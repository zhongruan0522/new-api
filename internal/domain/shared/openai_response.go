...
func (s *SimpleResponse) GetOpenAIError() *OpenAIError {
...
// GetOpenAIError 从动态错误类型中提取OpenAIError结构
func (o *OpenAITextResponse) GetOpenAIError() *OpenAIError {
...
func (c *ChatCompletionsStreamResponse) GetOpenAIError() *OpenAIError {
...
func (o *OpenAIResponsesResponse) GetOpenAIError() *OpenAIError {
...
func (r *ResponsesStreamResponse) GetOpenAIError() *OpenAIError {
	if r.Error != nil {
	...
	if r.Type == "error" && r.Message != "" {
		oaiError := &OpenAIError{Message: r.Message}
		if r.Code != nil {
...
// GetOpenAIError 从动态错误类型中提取OpenAIError结构
func GetOpenAIError(errorField any) *OpenAIError {
	if errorField == nil {
		return nil
	}
