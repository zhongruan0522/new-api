...
func TestGetRequestBodyDoesNotKeepLegacyBytesForDiskStorage(t *testing.T) {
	...
	oldConfig := cache.GetDiskCacheConfig()
	oldMaxRequestBodyMB := shared.MaxRequestBodyMB
	...
	t.Cleanup(func() {
		cache.SetDiskCacheConfig(oldConfig)
		shared.MaxRequestBodyMB = oldMaxRequestBodyMB
	})
