...
func CreateVendorMeta(c *gin.Context) {
	...
	if v.Name == "" {
		httpapi.ApiErrorI18n(c, i18n.MsgVendorMetaNameRequired)
		return
	}
	// 创建前先检查名称
	if dup, err := vendormetastore.IsVendorNameDuplicated(0, v.Name); err != nil {
		...
		httpapi.ApiErrorI18n(c, i18n.MsgVendorMetaNameExists)
		return
	}
...
func UpdateVendorMeta(c *gin.Context) {
	...
	if v.Id == 0 {
		httpapi.ApiErrorI18n(c, i18n.MsgVendorMetaMissingID)
		return
	}
	// 查询更新前的原始数据用于审计差异对比
