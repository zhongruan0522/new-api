...
func ReadResponseBody(r io.Reader) ([]byte, error) {
	return readResponseBodyWithLimit(r, shared.MaxTextResponseBodyMB, 16)
}

func ReadEmbeddingResponseBody(r io.Reader) ([]byte, error) {
	return readResponseBodyWithLimit(r, shared.MaxEmbeddingResponseBodyMB, 64)
}

func ReadMediaResponseBody(r io.Reader) ([]byte, error) {
	return readResponseBodyWithLimit(r, shared.MaxMediaResponseBodyMB, 64)
}

func ReadErrorResponseBody(r io.Reader) ([]byte, error) {
	return readResponseBodyWithLimit(r, shared.MaxErrorResponseBodyMB, 4)
}

func ReadModelListResponseBody(r io.Reader) ([]byte, error) {
	return readResponseBodyWithLimit(r, shared.MaxModelListResponseBodyMB, 8)
}
