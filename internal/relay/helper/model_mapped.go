...
func ModelMappedHelper(c *gin.Context, info *common.RelayInfo, request shared.Request) error {
	...
	if isResponsesCompact && strings.HasSuffix(originModelName, ratio.CompactModelSuffix) {
		mappingModelName = strings.TrimSuffix(originModelName, ratio.CompactModelSuffix)
	}
	...
	if isResponsesCompact {
		...
		info.OriginModelName = ratio.WithCompactModelSuffix(finalUpstreamModelName)
	}
	if request != nil {
