...
services:
  new-api:
    ...
    environment:
      ...
      - REDIS_CONN_STRING=redis://:123456@redis:6379 # ⚠️ IMPORTANT: Change this password in production!
      - TZ=Asia/Shanghai
...
| `REDIS_CONN_STRING`  | Redis connection string                             | `redis://:123456@redis:6379`          |
