...
const SecureVerificationModal = ({
  ...
  if (has2FA) availableMethods.push('2fa');
  if (hasPasskey && passkeySupported) availableMethods.push('passkey');
  ...
  // 2FA 验证区域
  const render2FA = () => (
    <div style={{ paddingTop: isSingleMethod ? '0' : '20px' }}>
