...
export const STATIC_I18N_KEYS = [
  ...
  'Audit: Update',
  'Audit: Delete',
  'Audit: Module - System Settings',
  'Audit: Module - Channels',
  'Audit: Module - Users',
  'Audit: Module - Tokens',
  ...
  'Audit: Module - Log Cleanup',
  'Audit: Module - System Setup',
  'Operator',
  'Module',
  'Action Type',
  'All Modules',
  ...
  'UsageLogField.name.request_id',
  'UsageLogField.desc.request_id',
  'UsageLogField.name.upstream_request_id',
  'UsageLogField.desc.upstream_request_id',
  'UsageLogField.name.retry_chain',
  'UsageLogField.desc.retry_chain',
  'UsageLogField.name.ip_address',
  'UsageLogField.desc.ip_address',
  'UsageLogField.name.client_headers',
  'UsageLogField.desc.client_headers',
  'UsageLogField.name.request_conversion',
  'UsageLogField.desc.request_conversion',
  'UsageLogField.name.reasoning_effort',
  'UsageLogField.desc.reasoning_effort',
  'UsageLogField.name.system_prompt_override',
  'UsageLogField.desc.system_prompt_override',
  'UsageLogField.name.model_mapping',
  'UsageLogField.desc.model_mapping',
  'UsageLogField.name.parameter_override',
  'UsageLogField.desc.parameter_override',
  'UsageLogField.name.billing_source',
  'UsageLogField.desc.billing_source',
  'UsageLogField.name.billing_details',
  'UsageLogField.desc.billing_details',
  'UsageLogField.name.price_table',
  'UsageLogField.desc.price_table',
  'UsageLogField.name.tiered_pricing',
  'UsageLogField.desc.tiered_pricing',
  'UsageLogField.name.violation_fee',
  'UsageLogField.desc.violation_fee',
  'UsageLogField.name.refund_details',
  'UsageLogField.desc.refund_details',
  'UsageLogField.name.subscription_billing',
  'UsageLogField.desc.subscription_billing',
  'UsageLogField.name.token_breakdown',
  'UsageLogField.desc.token_breakdown',
  'UsageLogField.name.audio_tokens',
  'UsageLogField.desc.audio_tokens',
  'UsageLogField.name.topup_audit',
  'UsageLogField.desc.topup_audit',
  'UsageLogField.name.operator_admin',
  'UsageLogField.desc.operator_admin',
  'UsageLogField.name.stream_status',
  'UsageLogField.desc.stream_status',
  ...
  'The ticket status will change to pending.',
  'Enter a concise title',
  'Describe the question or request',
  'Reopen',
  'Reply',
  'Updated At',
  ...
  'Wallet management and personal preferences.',
  ...
  'Detailed request logs for investigations.',
  'Manage uploaded multimodal file resources.',
  'Top up balance and view billing history.',
  'Search top-up orders by order number.',
  'Personal settings and profile management.',
  'Create, reply to, and manage support tickets.',
  'Manage dynamic ratio rules.',
