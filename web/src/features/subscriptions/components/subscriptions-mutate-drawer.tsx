    ...
    >
      <SheetContent className={sideDrawerContentClassName('sm:max-w-[600px]')}>
        <SheetHeader className={sideDrawerHeaderClassName()}>
          <SheetTitle>
            {isEdit
              ? t('subscriptions.fields.updatePlanInfo')
              : t('subscriptions.actions.createNewSubscriptionPlan')}
          </SheetTitle>
          <SheetDescription>
            {isEdit
              ? t(
              ...
              : t('subscriptions.actions.fillInTheFollowingInfoToCreateANew')}
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form
            ...
            <SideDrawerSection>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t('subscriptions.fields.planSubtitle')}
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('subscriptions.fields.actualAmount')}
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                    ...
                    <FormItem>
                      ...
                      <Select
                        items={[
                          {
                            value: '__none__',
                            label: t('subscriptions.fields.noUpgrade'),
                          },
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue
                              placeholder={t('subscriptions.fields.noUpgrade')}
                            />
                          </SelectTrigger>
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('subscriptions.fields.purchaseLimit')}
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('subscriptions.fields.durationUnit')}
                      </FormLabel>
                      <Select
                        items={[
                ...
                {durationUnit === 'custom' ? (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t('subscriptions.fields.customSeconds714d00')}
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t('subscriptions.fields.durationValue')}
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
            ...
            <SideDrawerSection>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t('subscriptions.fields.stripePriceId')}
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t('subscriptions.fields.creemProductId')}
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      <FormLabel>
                        {t('subscriptions.fields.waffoPancakeProductId')}
                      </FormLabel>
                      <div className='flex gap-2'>
                        ...
                        >
                          <SelectTrigger className='w-full flex-1'>
                            <SelectValue
                              placeholder={t(
                                'subscriptions.placeholders.selectAProduct'
                              )}
                            />
                          </SelectTrigger>
                          <SelectContent>
